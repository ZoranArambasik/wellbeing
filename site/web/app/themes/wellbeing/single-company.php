        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="res-ratings-main">
                        <span class="bold"><?php //_e('Rating:', 'Wellbeing'); ?> </span>
                        <span class="span-res-ratings"></span>
                        <?php echo do_shortcode('[wppr_avg_rating_post_id id="'. get_the_ID() .'"]'); ?> 
                        <span class="add-rating"><?php _e('Add rating:', 'Wellbeing');  ?></span>
                    </div>
                        ...
                        <div class="vote-section-inner">
                            <?php 
                                ...
                                foreach ( $comments as $comment ) {
                                    $ips[] = get_comment_author_IP($comment);
                                }
                               
                            ?>
                            <?php if (!in_array($ip, $ips)): ?>
                                <h4><?php  _e('We hope you enjoyed your visit and we love to have your feedback. How well do the ' . get_the_title() . ' deliver wellbeing to visitors?', 'Wellbeing'); ?></h4>
                                <?php echo comment_form(); ?> 
                                <div class="cancel-vote">
                                    <?php  _e('Cancel', 'Wellbeing'); ?>
                                </div>
                            <?php else: ?> 
                                <h4><?php _e('Thank you for your vote!', 'Wellbeing'); ?></h4>
                                <div class="cancel-vote" style="margin: 30px auto 0px auto;">
                                    <?php  _e('Close', 'Wellbeing'); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <?php 
                    if( $location ): ?>
                        <h4 class="map-title"><?php _e('Where we are at:', 'Wellbeing'); ?></h4>
