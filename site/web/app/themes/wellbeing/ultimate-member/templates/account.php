...
<div class="um <?php echo esc_attr( $this->get_class( $mode ) ); ?> um-<?php echo esc_attr( $form_id ); ?>">
	<div class="container um-form">
		<?php $current_user = wp_get_current_user(); 
		// var_dump($current_user->ID);
		// var_dump(get_field('company_small_description', $current_user));
		?>
		<form method="post" action="">
			...
			*/  ?>
			<div class="um-account-side uimob340-hide uimob500-hide">
				...
				*/  ?>
				<ul>
					...
					<li><a class="um-account-link" data-tab="evaluate-your-business" href="<?php bloginfo('url') ?>/evaluate-your-business">
						<span class="um-account-icon"><i class="<?php echo esc_attr( $info['icon'] ); ?>"></i></span>
						<span class="um-account-title"><?php _e( 'Evaluate your business', 'ultimate-member' ); ?></span>
						<span class="um-account-arrow uimob800-hide"><i class="um-faicon-angle-right"></i></span>
					</a></li>
					<li><a class="um-account-link" data-tab="edit-your-business" href="<?php bloginfo('url') ?>/edit-your-business">
						<span class="um-account-icon"><i class="<?php echo esc_attr( $info['icon'] ); ?>"></i></span>
						<span class="um-account-title"><?php _e( 'Edit your business', 'ultimate-member' ); ?></span>
						<span class="um-account-arrow uimob800-hide"><i class="um-faicon-angle-right"></i></span>
					</a></li>
				</ul>
			</div>
			...
			<?php } ?>
			<div class="um-account-tab um-account-tab-edit-your-business" data-tab="evaluate-your-business">
				<a class="classic-url-pink" href="<?php bloginfo('url') ?>/evaluate-your-business">Evaluate your business</a>
			</div>
			<div class="um-account-tab um-account-tab-edit-your-business" data-tab="edit-your-business">
				<a class="classic-url-pink" href="<?php bloginfo('url') ?>/edit-your-business">Edit your business</a>	
			</div>	
			</div>
